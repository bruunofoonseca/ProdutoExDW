        ...
        <nav class="navbar navbar-default sidebar" role="navigation">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    <li class="active format-active"><a href="${pageContext.request.contextPath}/listarTodosProdutos">Home<span style="font-size:16px;" class="pull-right showopacity glyphicon glyphicon-home"></span></a></li>
